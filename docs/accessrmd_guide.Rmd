...
<a href="docs/pres_format.html" target="_blank">View in presentation format (opens in new window)</a>.
...
[toc float test](./docs/test_toc.html)

[hybrid toc float test](./docs/test_hybrid.html)
