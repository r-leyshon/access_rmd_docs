...
Rmarkdown comes with some pre-packaged [themes and styles](rmd_style). 

<br>["cerulean.Rmd"](docs/test_themes//cerulean.html)
<br>["cosmo.Rmd"](docs/test_themes//cosmo.html)    
<br>["flatly.Rmd"](docs/test_themes//flatly.html)    
<br>["journal.Rmd"](docs/test_themes//journal.html)  
<br>["lumen.Rmd"](docs/test_themes//lumen.html)     
<br>["paper.Rmd"](docs/test_themes//paper.html)    
<br>["readable.Rmd"](docs/test_themes//readable.html)  
<br>["sandstone.Rmd"](docs/test_themes//sandstone.html)
<br>["simplex.Rmd" ](docs/test_themes//simplex.html)   
<br>["spacelab.Rmd"](docs/test_themes//spacelab.html) 
<br>["united.Rmd"](docs/test_themes//united.html)    
<br>["yeti.Rmd"](docs/test_themes//yeti.html)

## Testing highlights

<br>[breezedark.Rmd](docs/test_highlights//highlight_breezedark.html)
<br>[default.Rmd](docs/test_highlights//highlight_default.html)   
<br>[espresso.Rmd](docs/test_highlights//highlight_espresso.html) 
<br>[haddock.Rmd](docs/test_highlights//highlight_haddock.html)   
<br>[kate.Rmd](docs/test_highlights//highlight_kate.html)     
<br>[monochrome.Rmd](docs/test_highlights//highlight_monochrome.html)
<br>[null.Rmd](docs/test_highlights//highlight_null.html)      
<br>[pygments.Rmd](docs/test_highlights//highlight_pygments.html)  
<br>[tango.Rmd](docs/test_highlights//highlight_tango.html)     
<br>[textmate.Rmd](docs/test_highlights//highlight_textmate.html) 
<br>[zenburn.Rmd](docs/test_highlights//highlight_zenburn.html) 
